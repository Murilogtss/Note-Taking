...
const NoteList = ({
  ...
  const [editTaggleModalIsOpen, setEditTaggleModalIsOpen] =
  ...
  return (
    <>
      <Row className="align-items-center mb-4">
        ...
        <Col xs="auto">
          <Stack gap={2} direction="horizontal">
            ...
            <Button
              onClick={() => setEditTaggleModalIsOpen(true)}
      ...
      <EditTagsModel
        ...
        show={editTaggleModalIsOpen}
        handleClose={() => setEditTaggleModalIsOpen(false)}
